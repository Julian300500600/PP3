...
<details>
    ...
    <code>
     Man kann "Ordered List" oder "Unordered List" erstellen, indem man mit "1. " durchnummeriert oder mit "- " Listen erstellt. Tables kann man mit "|" & "-" einfach erstellen.  
    </code>
</details>
...
<details>
    ...
    example.pdf.aux, example.pdf.log, example.pdf.pdf
</details>

<details>
    <summary>How do you change the name of the pdf-file?</summary>
    Über die zuweisung mit dem jobname.
</details>
...
<details>
    ...
    Die PDF wird in einer xpdf umgebung angezeigt.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
   Man hat eine Seite mehr, da die erste Seite mit Name etc. vom Inhalt getrennt wird.
</details>
